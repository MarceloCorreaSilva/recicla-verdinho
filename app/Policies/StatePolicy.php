...
class StatePolicy
{
    ...
    {
        return $user->hasPermissionTo('state_access');
    }
    ...
    {
        return $user->hasPermissionTo('state_read');
    }
    ...
    {
        return $user->hasPermissionTo('state_create');
    }
    ...
    {
        return $user->hasPermissionTo('state_update');
    }
    ...
    {
        return $user->hasPermissionTo('state_delete');
    }
