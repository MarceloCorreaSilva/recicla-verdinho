...
<div class="filament-footer flex items-center justify-center">
    ...
    <footer class="-fixed bottom-4 z-20 w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
